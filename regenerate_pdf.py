...
# Get existing successful result
result = requests.get('http://localhost:8000/api/pipeline/results/140').json()
print("=== Regenerating PDF for Analysis ID 140 ===")
print(f"Status: {result['status']}")
print(f"Current PDF: {result.get('pdf_path')}")
...
# Generate PDF
pdf_path = Path('/data/opportunities/97c450b7d3554a738d0d4de07ffa0e0a/outputs/analysis_140_regenerated.pdf')
