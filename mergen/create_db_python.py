#!/usr/bin/env python3
"""
PostgreSQL Database Creation Script for ZgrBid
"""
import psycopg2
...
def insert_sample_data(conn):
    ...
    try:
        ...
        cursor.execute("""
            ...
            (2, 'Main conference room accommodates up to 100 participants with theater-style seating', array_fill(0.1, ARRAY[384]), 'paragraph', 1),
            (2, '2 breakout rooms available, each accommodating 15 participants', array_fill(0.1, ARRAY[384]), 'paragraph', 1),
            (2, 'Free airport shuttle service available every 30 minutes', array_fill(0.1, ARRAY[384]), 'paragraph', 1),
            (2, 'Complimentary high-speed Wi-Fi throughout the property', array_fill(0.1, ARRAY[384]), 'paragraph', 1);
        """)
